# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-06 21:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replies_written', models.IntegerField(default=models.IntegerField(default=1))),
            ],
        ),
        migrations.CreateModel(
            name='CampaignUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('writer_user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='campaigns.ProfileUser')),
            ],
        ),
        migrations.AddField(
            model_name='reply',
        ...
        migrations.AddField(
            ...
            name='campaign_user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='campaigns.ProfileUser'),
        ),
        migrations.AddField(
            model_name='campaign',
            name='owner',
